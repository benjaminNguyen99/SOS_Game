...
public class production_2AI {
   /*package*/ boolean player1 = true;
   /*package*/ boolean player2 = true;
   public class multi
	{
		int sc;
		public String no;
   ...
   public int minimax(JButton[] Node, int depth, boolean currentstate, int c) {
      boolean cond = true;
   ...
   public JButton[] forAI(int a, JButton[] Node, boolean player) {
      int signal = -10000;
      			int pick_index = 0;
